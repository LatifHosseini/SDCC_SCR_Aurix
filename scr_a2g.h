...
extern uint8_t scr_xram[571];

#define OFFSET_scr_xram    (0) /*(0x0) */
#define SIZE_scr_xram      (571) /*(0x23b) */

#define LABEL_scr_xram___sdcc_init_data      (278) /*(0x116) */
#define LABEL_scr_xram__00102      (411) /*(0x19b) */
#define LABEL_scr_xram__00104      (413) /*(0x19d) */
#define LABEL_scr_xram__00137      (447) /*(0x1bf) */
#define LABEL_scr_xram__00155      (501) /*(0x1f5) */
#define LABEL_scr_xram__00156      (503) /*(0x1f7) */
#define LABEL_scr_xram__00143      (508) /*(0x1fc) */
#define LABEL_scr_xram__00144      (538) /*(0x21a) */
#define LABEL_scr_xram__00157      (524) /*(0x20c) */
#define LABEL_scr_xram__00158      (526) /*(0x20e) */
#define LABEL_scr_xram__00140      (531) /*(0x213) */
#define LABEL_scr_xram__00145      (541) /*(0x21d) */
...
#define LABEL_scr_xram__00101      (569) /*(0x239) */
#define LABEL_scr_xram__00101      (570) /*(0x23a) */
...
#define LABEL_scr_xram___xdatac_end      (7426) /*(0x1d02) */
#define LABEL_scr_xram___xdatac_start      (7424) /*(0x1d00) */
#define LABEL_scr_xram__scr_adc_init      (570) /*(0x23a) */
#define LABEL_scr_xram__etext      (571) /*(0x23b) */
#define LABEL_scr_xram_s_PSEG      (7169) /*(0x1c01) */
#define LABEL_scr_xram__rtc_interrupt      (448) /*(0x1c0) */
#define LABEL_scr_xram___roxdata_end      (571) /*(0x23b) */
...
#define LABEL_scr_xram___xdatai_end      (7426) /*(0x1d02) */
#define LABEL_scr_xram___sdcc_gsinit1_start      (265) /*(0x109) */
#define LABEL_scr_xram___xdatai_start      (7426) /*(0x1d02) */
#define LABEL_scr_xram_s_XSEG      (7424) /*(0x1d00) */
#define LABEL_scr_xram___pdata_end      (7169) /*(0x1c01) */
#define LABEL_scr_xram___roxdata_start      (571) /*(0x23b) */
#define LABEL_scr_xram_s_XINIT      (571) /*(0x23b) */
#define LABEL_scr_xram___sdcc_external_startup      (377) /*(0x179) */
#define LABEL_scr_xram__var_1      (7424) /*(0x1d00) */
...
#define LABEL_scr_xram__gpoi_init      (414) /*(0x19e) */
#define LABEL_scr_xram___init_table      (256) /*(0x100) */
#define LABEL_scr_xram__scr_rtcInit      (554) /*(0x22a) */
#define LABEL_scr_xram_s_XISEG      (7426) /*(0x1d02) */
