...
extern uint8_t scr_xram[567];

#define OFFSET_scr_xram    (0) /*(0x0) */
#define SIZE_scr_xram      (567) /*(0x237) */

#define LABEL_scr_xram___sdcc_init_data      (278) /*(0x116) */
#define LABEL_scr_xram__00102      (408) /*(0x198) */
#define LABEL_scr_xram__00104      (410) /*(0x19a) */
#define LABEL_scr_xram__00137      (444) /*(0x1bc) */
#define LABEL_scr_xram__00139      (460) /*(0x1cc) */
#define LABEL_scr_xram__00157      (514) /*(0x202) */
#define LABEL_scr_xram__00158      (516) /*(0x204) */
#define LABEL_scr_xram__00145      (521) /*(0x209) */
#define LABEL_scr_xram__00146      (551) /*(0x227) */
#define LABEL_scr_xram__00159      (537) /*(0x219) */
#define LABEL_scr_xram__00160      (539) /*(0x21b) */
#define LABEL_scr_xram__00142      (544) /*(0x220) */
#define LABEL_scr_xram__00147      (554) /*(0x22a) */
...
#define LABEL_scr_xram__etext      (567) /*(0x237) */
#define LABEL_scr_xram_s_PSEG      (7169) /*(0x1c01) */
#define LABEL_scr_xram__rtc_interrupt      (461) /*(0x1cd) */
#define LABEL_scr_xram___roxdata_end      (567) /*(0x237) */
...
#define LABEL_scr_xram___roxdata_start      (567) /*(0x237) */
#define LABEL_scr_xram_s_XINIT      (567) /*(0x237) */
...
#define LABEL_scr_xram__gpoi_init      (411) /*(0x19b) */
#define LABEL_scr_xram___init_table      (256) /*(0x100) */
#define LABEL_scr_xram__scr_rtcInit      (445) /*(0x1bd) */
