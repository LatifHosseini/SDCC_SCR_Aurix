...
void scr_adc_disable_modu(void);
void scr_isAdc_enabled(void);
void scr_adc_isReadyForNewConversion(void);
void scr_adc_selectChannel(void);
void scr_adc_selectSampleTime(void);
