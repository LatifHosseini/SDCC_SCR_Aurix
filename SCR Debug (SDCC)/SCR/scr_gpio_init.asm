...
;------------------------------------------------------------
;	../SCR/scr_gpio_init.c:53: void gpio_init(void){
;	-----------------------------------------
;	 function gpio_init
;	-----------------------------------------
...
_gpio_init:
	.using 0
;	../SCR/scr_gpio_init.c:56: SCR_IO_PAGE = 2;        //Switch to page 2
	mov	_SCR_IO_PAGE,#0x02
;	../SCR/scr_gpio_init.c:57: SCR_P00_PDISC = 0x00;
	mov	_SCR_P00_PDISC,#0x00
;	../SCR/scr_gpio_init.c:58: SCR_P01_PDISC = 0x00;
	mov	_SCR_P01_PDISC,#0x00
;	../SCR/scr_gpio_init.c:60: SCR_IO_PAGE = 1;        //Switch to page 1
	mov	_SCR_IO_PAGE,#0x01
;	../SCR/scr_gpio_init.c:61: SCR_P00_IOCR3 = 0x80;
	mov	_SCR_P00_IOCR3,#0x80
;	../SCR/scr_gpio_init.c:62: SCR_P00_IOCR4 = 0x80;
	mov	_SCR_P00_IOCR4,#0x80
;	../SCR/scr_gpio_init.c:63: SCR_P00_IOCR5 = 0x80;
	mov	_SCR_P00_IOCR5,#0x80
;	../SCR/scr_gpio_init.c:65: SCR_IO_PAGE = 1;  // Switch IO PAGE 1
	mov	_SCR_IO_PAGE,#0x01
;	../SCR/scr_gpio_init.c:66: SCR_P01_IOCR2 = 0x08;    // Configure P00.2 as Input and Input pull-down device connected -> PC = 0XX01
	mov	_SCR_P01_IOCR2,#0x08
;	../SCR/scr_gpio_init.c:67: SCR_IO_PAGE = 0;         // Switch IO PAGE 0
	mov	_SCR_IO_PAGE,#0x00
;	../SCR/scr_gpio_init.c:69: SCR_IO_PAGE = 2;
	mov	_SCR_IO_PAGE,#0x02
;	../SCR/scr_gpio_init.c:70: SCR_P00_PDISC  &= ~(1 << 2);
	anl	_SCR_P00_PDISC,#0xFB
;	../SCR/scr_gpio_init.c:71: SCR_P00_PDR2 |= 0x08;  // PAGE = 2;
	orl	_SCR_P00_PDR2,#0x08
;	../SCR/scr_gpio_init.c:72: SCR_IO_PAGE = 0;
	mov	_SCR_IO_PAGE,#0x00
;	../SCR/scr_gpio_init.c:76: SCR_SCU_PAGE = 2;
	mov	_SCR_SCU_PAGE,#0x02
;	../SCR/scr_gpio_init.c:77: SCR_MODPISEL1 |= 0x00;// Bit 00 -> EXINT2A mit MUX gewählt,
	mov	_SCR_MODPISEL1,_SCR_MODPISEL1
;	../SCR/scr_gpio_init.c:78: SCR_MODPISEL2 |= 0x00;// Bit 00 -> EXINT5A mit MUX gewählt,
	mov	_SCR_MODPISEL2,_SCR_MODPISEL2
;	../SCR/scr_gpio_init.c:79: SCR_SCU_PAGE = 0;
	mov	_SCR_SCU_PAGE,#0x00
;	../SCR/scr_gpio_init.c:81: SCR_SCU_PAGE = 1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/scr_gpio_init.c:82: SCR_EXICON0 = 0x0F; // Bit Name EXINT2 und Nummer [4-5]= 00 in Reg EXICON0 Node 8
	mov	_SCR_EXICON0,#0x0F
;	../SCR/scr_gpio_init.c:83: SCR_EXICON1 = 0xF4; // Bit Name EXINT5 und Nemmer [2-3]= 01 in Reg EXICON1 Node 9
