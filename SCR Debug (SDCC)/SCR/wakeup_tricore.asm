...
;------------------------------------------------------------
;	../SCR/wakeup_tricore.c:53: void TrigerWakeUpFromStandbyMode(void){
;	-----------------------------------------
...
_TrigerWakeUpFromStandbyMode:
	.using 0
;	../SCR/wakeup_tricore.c:55: SCR_SCU_PAGE = 1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/wakeup_tricore.c:56: SCR_SCU_STDBYWKP |= (1 << 0); //set Bit 0 of SCU_STDBYWKP Register to 1 then trigger a wakeup
	orl	_SCR_SCU_STDBYWKP,#0x01
.00101:
;	../SCR/wakeup_tricore.c:57: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'IsStandbyMode'
;------------------------------------------------------------
;	../SCR/wakeup_tricore.c:59: unsigned char IsStandbyMode(void){
;	-----------------------------------------
...
_IsStandbyMode:
	.using 0
;	../SCR/wakeup_tricore.c:66: SCR_SCU_PAGE = 0;
	mov	_SCR_SCU_PAGE,#0x00
;	../SCR/wakeup_tricore.c:67: return (SCR_SCU_SR && 0x4);
	mov	a,_SCR_SCU_SR
	jnz	.00106
.00112:
;	assignBit
